%% Diseño de Vigas W Acero | Flexión y Cortante
% clc; 
clear;
% Cálculo acorde a AISC
% Cap. B | Design Requirements
% Cap. F | Design of members for flexure (F2, F3)
...
% --- Datos STAAD.Pro ---
Vu = 25.35;      %[kips] Cortante max.
Mu = 2430;         %[in-kips] Momento max.
M_max = Mu;     %[in*kips] Momento máximo
MA = 566;        %[in*kips] Momento a 1/4 del segmento no arriostrado
MB = 1168;        %[in*kips] Momento a 1/2 del segmento no arriostrado
MC = 1789;        %[in*kips] Momento a 3/4 del segmento no arriostrado
