function [d_arq,d_central,d_food,i_arq,i_central,i_food,AY_arq,AY_central,AY_food,AZ_arq,AZ_central,AZ_food,e_arq1,e_arq2,e_cent_arq1,e_cent_arq2,e_central1,e_cent_food1,e_food1,e_food2,e_food3,e_food4,e_food5,e_food6,e_food7,e_food8,e_food9] = Lector_senales_est(Data_val,vec_tiempo)
% Lee el archivo de señales ya importado y obtiene las gráficas generales
%   para los 4 tipos de sensores durante las pruebas estáticas R9 y R10
...
AY_arq = Data_val(:,3); % 3054, se toma como perdido
AY_central = Data_val(:,27); % 3055 
AY_food = Data_val(:,13); % 3053, se toma como perdido

% Acelerometros dirección Z
AZ_arq = Data_val(:,4); % 3054, se toma como perdido
AZ_central = Data_val(:,26); % 3055
AZ_food = Data_val(:,14); % 3053, se toma como perdido
...
ylabel('G(s)') %Eje 
legend('Central','Color','w','Location','eastoutside')
